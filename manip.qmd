...
For thinking logically about data manipulations and for efficient use of your time, it is best to thoroughly learn the `data.table` algebra.  But you can also use a large language model as an assistant in developing `data.table` code as demonstrated in @sec-long-ai.
