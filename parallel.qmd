...
See [this](https://fharrell.com/post/aci) for an example where the per-core function (`g` above) returns a data table, and the multiple data tables are combined into one long data table over the simulations.
